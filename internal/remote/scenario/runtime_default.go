...
func NewDefaultRuntime(channels *channel.Registry, bindings *binding.Resolver, audit AuditFunc) *DefaultRuntime {
...
func (r *DefaultRuntime) Resolve(_ context.Context, ev Event) (channel.Channel, channel.Target, bool, error) {
	...
	if err != nil {
		return nil, channel.Target{}, false, err
	}
	if resolved == nil {
		return nil, channel.Target{}, false, nil
	}
	...
	target := channel.Target{ChatID: resolved.Binding.ChatID}
...
func (r *DefaultRuntime) Notify(ctx context.Context, ch channel.Channel, target channel.Target, msg interaction.Notification) error {
	if ch == nil {
...
// context fires.
func (r *DefaultRuntime) Ask(ctx context.Context, ch channel.Channel, target channel.Target, ix interaction.Interaction) (interaction.Reply, error) {
	if ch == nil {
